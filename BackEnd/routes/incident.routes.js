...
router.post('/', authMiddleware, verifyRole('user', 'admin', 'superAdmin'), validateUserReputation, middleClaudinary, aiIncidentValidation, create);router.get('/',           authMiddleware, verifyRole('admin', 'superAdmin'), getAll);
